...
class ImageBuilder {
    ...
    uploadPackage(containerName, blobName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (Utils_2.default.IsEqual(this._taskParameters.provisioner, "powershell")) {
                    archivedWebPackage = yield this.createArchiveTar1(this._taskParameters.buildPath, this._generateTemporaryFile('/home/runner/work/imageBuilder/', `.zip`));
                }
                else {
                    archivedWebPackage = yield this.createArchiveTar(this._taskParameters.buildPath, this._generateTemporaryFile('/home/runner/work/imageBuilder/', `.tar.gz`));
                }
            }
            catch (error) {
