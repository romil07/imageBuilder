        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (isCreateBlob) {
                    ...
                    yield this.executeAzCliCommand(`role assignment create --assignee-object-id ${this.principalId} --role "Storage Blob Data Reader" --scope /subscriptions/${subscriptionId}/resourceGroups/${this._taskParameters.resourceGroupName}/providers/Microsoft.Storage/storageAccounts/${this.storageAccount}/blobServices/default/containers/${this.containerName}`);
