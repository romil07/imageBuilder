...
class ImageBuilder {
    ...
    getTemplateName() {
        if (this._taskParameters.isTemplateJsonProvided) {
            ...
            return templateName == "" ? constants.imageTemplateName + Utils_1.getCurrentHumanReadableDate() : templateName;
        }
        ...
        return constants.imageTemplateName + Utils_1.getCurrentHumanReadableDate();
    }
    getRunoutputName() {
